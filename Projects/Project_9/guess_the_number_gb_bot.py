...
# Цикл while будет работать с последним ввёденным сообщением, а попадаем мы в него, когда вводим /play. Поэтому в строке:

# guess = int(message.text)
# Всегда будет ошибка. Цикл тут не нужен. Цикл уже есть в:

# bot.polling(none_stop=True)
# Надо после /play отлавливать все числа, что введёт пользователь.
